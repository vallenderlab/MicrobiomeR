...
#' \code{\link[metacoder:metacoder]{metacoder}} package by providing tools that mimic the
#' \code{\link[phyloseq:phyloseq-package]{phyloseq}} package. The main difference is
#' that the primary data object is a \code{\link[metacoder:taxmap]{taxmap object}}
#' instead of a \code{\link[phyloseq:phyloseq-class]{phyloseq object}}.
#'
