...
The example counts colors from the same deterministic, reduced dataset used by the other
executable vignettes; it is illustrative and does not replace the full exported dataset.
