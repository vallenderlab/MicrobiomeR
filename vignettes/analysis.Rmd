...
produces `heat_tree()`s.  MicrobiomeR does this as well, but takes care of creating default values
that the developers enjoyed in their heat tree plots.  MicrobiomeR also uses ggplot2 to create 
`correlation_plot()`s.
