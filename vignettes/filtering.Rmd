...
the executed examples use a deterministic subset containing four samples from each treatment
group and the 100 most abundant OTUs. These results illustrate filtering behavior and should
not be interpreted as estimates from the full study.
...
such as `metacoder::filter_ambiguous_taxa()`, `metacoder::filter_taxa()`, and `taxa::filter_obs()` for instance
