...
test_that("basic agglomerate_metacoder works", {
  expect_false(any(unique(taxon_ranks(agglomerate_metacoder(raw_silva_2, "Phylum"))) %in% c("Class", "Order", "Family", "Genus", "Species")))
})
