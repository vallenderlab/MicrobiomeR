...
test_that("which_format works", {
  expect_equal(which_format(create_metacoder(phyloseq_silva_2)), "phyloseq_format")
...
test_that("is_*_format works", {
  expect_true(is_phyloseq_format(create_metacoder(phyloseq_silva_2)))
  expect_false(is_phyloseq_format(raw_silva_2))
  expect_true(is_raw_format(raw_silva_2))
  expect_false(is_raw_format(create_metacoder(phyloseq_silva_2)))
